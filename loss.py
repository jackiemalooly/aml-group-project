...
class v8DetectionLoss:
    ...
    def __init__(self, model, tal_topk=10):  # model must be de-paralleled
        ...
        # self.bce = nn.BCEWithLogitsLoss(reduction="none")  # Commented out BCE
        self.hyp = h
    ...
    def __call__(self, preds, batch):
        ...
        # Cls loss
        loss[1] = VarifocalLoss.forward(pred_scores, target_scores.to(dtype), gt_labels) / target_scores_sum  # VFL way
