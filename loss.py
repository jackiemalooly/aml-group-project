...
class FocalLoss(nn.Module):
    ...
    @staticmethod
    def forward(pred, label, gamma=1.5, alpha=1.00):
...
class v8DetectionLoss:
    ...
    def __call__(self, preds, batch):
        ...
        # Simple one-hot encoding using scatter
        ...
        # print("target_labels_onehot shape:",target_labels_onehot.shape)
        # print("target_labels shape:", target_labels.shape)
        # print("pred_scores:",pred_scores[0,:5,:5])
        # print("target_labels:",target_labels[0,:5])
        # print("target_labels_onehot:",target_labels_onehot[0,:5,:5])
